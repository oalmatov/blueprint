<!-- Vals agent benchmark — auto-generated by valsmith from this repo's merged PRs.
     Static mockup; future: serve agent-leaderboard.svg live from https://api.vals.ai/blueprint -->
<a href="https://vals.ai">
  <img src="./.github/vals/agent-leaderboard.svg?v=10" alt="Vals — Agent Leaderboard" width="680">
</a>
