<!-- Vals agent benchmark — auto-generated by valsmith from this repo's merged PRs.
     Static mockup; future: swap src to https://api.vals.ai/blueprint/agent-leaderboard.svg for live data. -->
<a href="https://vals.ai">
  <img src="./.github/vals/agent-leaderboard.svg?v=3" alt="Vals — Agent Leaderboard" width="378">
</a>
